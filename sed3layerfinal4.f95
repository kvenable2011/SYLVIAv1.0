...
open(unit=15, file="F:\Sediment HMS\mass15APR20l.text",status="new")
open(unit=25, file="F:\Sediment HMS\conc15APR20l.text", status="new")
...
!    conc_time_3(j) = benthic_layer_3(8,j)
    ...
    !end if 
    !print*, sed_1(:,j) 
    write(15,*) j, timeout(8,j), timeout_1(8,j), benthic_layer_3(8,j), benthic_layer_3(4,j),benthic_layer_3(10,j)
