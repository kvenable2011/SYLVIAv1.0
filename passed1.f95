subroutine passed1(state_var,i,rhos,sv,maxlyrd,tsf,pdx,pdy,state_att,a,comid,freq_count,conc_i,d_m_i,d_conc_i,num_par_1,d_m)  
implicit none 
...
state_var(1:9)= (/real(i), m_1, sv, maxlyrd,tsf, pdx, pdy, m_1, m_1/)
print*, state_var
state_att(1:7)= (/a, ds,real(seg),d_m_i,d_conc_i,rhos,num_par_1/)
print*, state_att
!print*, freq_count
