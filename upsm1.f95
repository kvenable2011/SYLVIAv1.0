...
open(unit=10, file="C:\Users\kvenable\Output\GlobalStateFile19MAY20b.txt",status="new")
call cpu_time(start)
!call date_and_time(
open(unit=15, file="C:\Users\kvenable\Output\XY19MAY20b.txt",status="new")
open(unit=25, file="C:\Users\kvenable\Output\mass19MAY20b.txt", status="new")
open(unit=35, file="C:\Users\kvenable\Output\conc19MAY20b.txt", status="new")
...
do j=1,rtm,tinc
    ...
    tsv_1 =state_var_time_1(3)/state_att_1(4,1)!Total Settling Velocity LY1
    tsv_2 =state_var_time_2(3)/state_att_1(4,2)!Total Settling Velocity LY2
    tsv_3 =state_var_time_3(3)/state_att_1(4,3)!Total Settling Velocity LY3
