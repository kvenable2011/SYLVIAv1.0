subroutine passed2(state_var,i,m_1,maxlyrd,tsf,pdx,pdy,state_att,a,freq_count,tb,dprob) !taub!(state_var, i, rhos, sv, maxlyrd, tsf, pdx,pdy, state_att,freq_count) !Don't think I need all the single vars 
implicit none 
real :: freq_count(7), state_att(6), state_var(6)
real :: m_1, tsf, maxlyrd, pdx, pdy, rhos, ds, a, dlayer, tb, dprob !taub 
integer :: i,seg,j
...
write(10,*) state_var
print*, state_var
state_att(1:6)= (/a, ds,real(seg),rhos, tb, dprob/)!taub
write(10,*) state_att
print*, state_att
!print*, freq_count
