subroutine passed3 (state_var,i,m_1,maxlyrd_b,tsf,pdx,pdy,state_att,a,tb,dprob) !freq_count!taub
implicit none 
...
call location(seg) 
!common /shear/taub
call sedflux5(rhob,ds,tsf,dprob)!freq_count
