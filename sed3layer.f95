...
real, dimension (:), allocatable, target ::conc_time_1, mass_time_1,conc_time_2, conc_time_3, mass_time_2, mass_time_3
real, dimension (:), pointer :: test1
real, dimension (:), allocatable:: output_mass
...
open(unit=2, file="F:\Sediment HMS\mass14APR20e.text",status="new")
open(unit=3, file="F:\Sediment HMS\conc14APR20e.text", status="new")
...
!num_par_1 = conc_i*lc*a
    ...
    benthic_layer_3(6,j)= pdx
    benthic_layer_3(7,j)= (state_var_time_2(4)+.01) +(state_var_time_3(5)*real(j)) !For relative depth below the water column 
