...
real(kind=4), allocatable::mad(:), mad_b(:), mad_1(:), ml_ly1(:), ml_ly2(:), ml_ly3(:)
...
common /shear/tb 
open(unit=10, file="C:\Users\kvenable\Output\GlobalStateFile03Jul22b.txt",status="new")
call cpu_time(start)
!call date_and_time
open(unit=15, file="C:\Users\kvenable\Output\XY03Jul22b.txt",status="new")
open(unit=25, file="C:\Users\kvenable\Output\mass03Jul22b.txt", status="new")
open(unit=35, file="C:\Users\kvenable\Output\conc03Jul22b.txt", status="new")
open(unit=45, file="C:\Users\kvenable\Output\mad03Jul22b.txt", status="new")
open(unit=55, file="C:\Users\kvenable\Output\ml03Jul22b.txt", status="new")
open(unit=65, file="C:\Users\kvenable\Output\inputmatrixpass03Jul22b.txt", status="new")
