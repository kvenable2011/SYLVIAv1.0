...
common /shear/tb 
open(unit=10, file="C:\Users\kvenable\Output\GlobalStateFile10Jun22m.txt",status="new")
call cpu_time(start)
!call date_and_time
open(unit=15, file="C:\Users\kvenable\Output\XY10Jun22m.txt",status="new")
open(unit=25, file="C:\Users\kvenable\Output\mass10Jun22m.txt", status="new")
open(unit=35, file="C:\Users\kvenable\Output\conc10Jun22m.txt", status="new")
open(unit=45, file="C:\Users\kvenable\Output\mad10Jun22m.txt", status="new")
open(unit=55, file="C:\Users\kvenable\Output\ml10Jun22m.txt", status="new")
open(unit=65, file="C:\Users\kvenable\Output\inputmatrixpass10Jun22m.txt", status="new")
