...
real :: m_1, tsf, maxlyrd, pdx, pdy, rhos, ds, a, rsv, dlayer, init_area
integer :: i,seg,j
j=0
pdx=0
pdy=0 
...
m_1 = tsf * init_area !runtime(4,1)!a - place back in main program replacing with inital area calculated!-times 1 day in g/d*m^2 For coversion scaling conversion for tsf cm^2 to m^2. Has an assumption that 1 day is multiplied to get the concentration 
print*, m_1 
